                    ...
                    <li
                      className={`uppercase px-4 mt-6 lg:mt-0 ${
                        router.pathname === "/"
                          ...
                          : "pb-9 lg:pb-0 hover:md:pb-0 hover:after:border-b-4 hover:after:border-gray hover:lg:pt-8 hover:after:pb-7 hover:after:w-full hover:after:content[''] hover:after:block"
                      }`}
                    >
                      <Link href="/" passHref>
