    ...
    <div className="background">
      ...
      <main className="flex flex-col min-h-screen text-center">
        ...
        <div className="flex flex-col justify-start items-center min-h-screen text-center mt-10 mx-1">
          ...
          <button className="bg-white m-auto mb-24 rounded-full w-[150px] h-[150px] font-bellefair text-xl uppercase tracking-wider leading-6 hover:ring-[40px] hover:ring-gray hover:ring-opacity-60">
            Explore
          </button>
        </div>
      </main>
